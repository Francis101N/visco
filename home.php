...
<body>
                ...
                <div class="max-w-7xl mx-auto px-6">
                    <div class="slide-text backdrop-blur-md bg-white/10 p-8 rounded-2xl max-w-xxl text-white opacity-0 shadow-lg">
                        ...
                        <p class="mt-4 text-gray-200">
                            Offshore & Onshore Project Expertise.
                        </p>
                        <a href="#"
    ...
    <section class="py-20 bg-gradient-to-br from-[#020617] to-[#0f172a]">
        <div class="max-w-6xl mx-auto px-6 lg:px-12">

            <!-- Title -->
            <div class="text-center mb-10">
                <h2 class="text-3xl md:text-5xl font-extrabold text-white">
                    Watch <span class="text-viscoYellow">ST. PETERS </span> Night View
                </h2>
                <p class="text-gray-400 mt-3">A glimpse into our operations, projects, and impact.</p>
            </div>
            ...
            <div class="relative group rounded-2xl overflow-hidden shadow-2xl">
                ...
                <video id="videoPlayer"
                    ...
                    playsinline
                    loop>
                    <source src="images/st-peters.mp4" type="video/mp4">
                </video>
                ...
                <div class="absolute bottom-0 left-0 w-full p-6 bg-gradient-to-t from-black/80 to-transparent">
                    <h3 class="text-white text-xl font-semibold">Project Showcase</h3>
                    <p class="text-gray-300 text-sm">Behind the scenes of our operations and field execution</p>
                </div>
